...
KEXT_META = {
    ...
    "SMCRadeonSensors":             ("SMCRadeonSensors.kext",             "Contents/MacOS/SMCRadeonSensors",             "", ""),
    "Polaris22Fixup":               ("Polaris22Fixup.kext",               "Contents/MacOS/Polaris22Fixup",               "", ""),
    ...
    "UTBMap":                       ("UTBMap.kext",                       "",                                            "", ""),
    # ── New additions ─────────────────────────────────────────────────────────
    "SMCLightSensor":               ("SMCLightSensor.kext",               "Contents/MacOS/SMCLightSensor",               "", ""),
    "SMCDellSensors":               ("SMCDellSensors.kext",               "Contents/MacOS/SMCDellSensors",               "", ""),
    "SmallTreeIntel82576":          ("SmallTreeIntel82576.kext",          "Contents/MacOS/SmallTreeIntel82576",          "", ""),
    "AtherosL1cEthernet":           ("AtherosL1cEthernet.kext",           "Contents/MacOS/AtherosL1cEthernet",           "", ""),
    "AppleIGC":                     ("AppleIGC.kext",                     "Contents/MacOS/AppleIGC",                     "", ""),
    "AppleIntelE1000e":             ("AppleIntelE1000e.kext",             "Contents/MacOS/AppleIntelE1000e",             "", ""),
    "RealtekRTL8100":               ("RealtekRTL8100.kext",               "Contents/MacOS/RealtekRTL8100",               "", ""),
    "BCM5722D":                     ("BCM5722D.kext",                     "Contents/MacOS/BCM5722D",                     "", ""),
    "ATH9KFixup":                   ("ATH9KFixup.kext",                   "Contents/MacOS/ATH9KFixup",                   "", ""),
    "USBWakeFixup":                 ("USBWakeFixup.kext",                 "Contents/MacOS/USBWakeFixup",                 "", ""),
    "EmeraldSDHC":                  ("EmeraldSDHC.kext",                  "Contents/MacOS/EmeraldSDHC",                  "", ""),
    "AppleMCEReporterDisabler":     ("AppleMCEReporterDisabler.kext",     "",                                            "", ""),
    "CPUTopologyRebuild":           ("CpuTopologyRebuild.kext",           "Contents/MacOS/CpuTopologyRebuild",           "", ""),
    "VoodooInput":                  ("VoodooInput.kext",                  "Contents/MacOS/VoodooInput",                  "", ""),
    "GK701HIDDevice":               ("GK701HIDDevice.kext",               "Contents/MacOS/GK701HIDDevice",               "", ""),
    "DebugEnhancer":                ("DebugEnhancer.kext",                "Contents/MacOS/DebugEnhancer",                "", ""),
}

KEXT_ORDER = [
    "Lilu", "VirtualSMC", "SMCProcessor", "SMCSuperIO",
    "SMCLightSensor", "SMCDellSensors",
    "WhateverGreen", "AppleALC", "RestrictEvents", "NVMeFix",
    "CPUFriend", "CpuTscSync", "AmdTscSync",
    "AMDRyzenCPUPowerManagement", "SMCAMDProcessor",
    "AppleMCEReporterDisabler", "CPUTopologyRebuild",
    "RTCMemoryFixup", "FeatureUnlock", "CryptexFixup",
    "SMCRadeonSensors", "Polaris22Fixup",
    "IntelMausi", "RealtekRTL8111", "AtherosE2200Ethernet",
    "LucyRTL8125Ethernet", "AppleIGB",
    "SmallTreeIntel82576", "AtherosL1cEthernet",
    "AppleIGC", "AppleIntelE1000e", "RealtekRTL8100", "BCM5722D",
    "AirportItlwm", "itlwm", "AirportBrcmFixup", "ATH9KFixup",
    "IntelBluetoothFirmware", "IntelBTPatcher", "BlueToolFixup",
    "BrcmPatchRAM3", "BrcmFirmwareData", "BrcmBluetoothInjector",
    "VoodooPS2Controller", "VoodooI2C", "VoodooI2CHID", "VoodooInput",
    "VoodooRMI", "VoodooSMBus", "AlpsHID",
    "ECEnabler", "SMCBatteryManager", "BrightnessKeys",
    "HibernationFixup", "NoTouchID",
    "GenericUSBXHCI", "USBToolBox", "USBWakeFixup", "UTBMap",
    "RealtekCardReader", "RealtekCardReaderFriend", "EmeraldSDHC",
    "AsusSMC", "YogaSMC", "GK701HIDDevice",
    "DebugEnhancer",
]
